defmodule Chronik.Aggregate do
  ...
  * `snapshot_every` indicates that a snapshot must be done on the
  ...
  """
  @callback handle_command(command :: Chronik.command, state :: state) :: [Chronik.domain_event] | no_return
  ...
  """
  @spec command(module :: module, id :: Chronik.id, cmd :: term) :: :ok | {:error, String.t}
  ...
  """
  @spec start_link(module :: module, id :: Chronik.id) :: {:ok, pid}
